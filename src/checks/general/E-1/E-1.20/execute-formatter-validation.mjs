export async function executeFormatterValidation({ root, executeFormat, mode, runFormatter }) {
  if (!executeFormat || (mode !== null && mode !== "format" && mode !== "format-check")) return null;
  try {
