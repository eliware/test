...
export async function runToolkitLifecycle(context) {
  ...
  const validationOutcome = await runPostTestValidation({ cwd, testResult, write, readFilePath, statPath, startedAt, ignoreCoverage, runLintCommand, lintOptions: { accessPath, findIstanbulIgnores, debugTiming: context.debugTiming, inspect, runChildProcess }, enforceMonolithLimits, findMonolith, monolithOptions: { workers }, ignoreMonolithLimits, timing, packageChecks: { runChildProcess, readPackageJson, readFilePath } });
