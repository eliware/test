...
export function validateToolkitOptions(options, operation = 'toolkit') {
  ...
  for (const name of ['runTest', 'runLintCommand', 'runChildProcess', 'readPackageJson', 'accessPath', 'removePath', 'readFilePath', 'statPath', 'findIstanbulIgnores', 'findMonolith', 'findSourceTestMapping', 'inspectWorkspace']) if (name in options && typeof options[name] !== 'function') throw new TypeError(`${operation} option ${name} must be a function`);
