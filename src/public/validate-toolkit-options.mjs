...
export function validateToolkitOptions(options, operation = 'toolkit') {
  ...
  for (const name of ['runTest', 'runLintCommand', 'accessPath', 'removePath', 'readFilePath', 'findIstanbulIgnores', 'findMonolith', 'findSourceTestMapping', 'inspectWorkspace']) if (name in options && options[name] !== undefined && typeof options[name] !== 'function') throw new TypeError(`${operation} option ${name} must be a function`);
