...
export async function validateCoverage(cwd, output, write, readFilePath) {
  try { const gaps = await readCoverage(cwd, output, write, readFilePath); if (gaps.length) { write(formatGaps(gaps, cwd)); return EXIT_CODES.COVERAGE_GAP; } return 0; }
