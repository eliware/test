...
export function checkSpecifications(specFiles, overview) {
  ...
  if (overview && specFiles.some((file) => file !== overview && !hasDirectLink(overview, file, 'specs'))) findings.push(finding('specs/: overview does not link to every specification document'));
  return findings;
}
