...
test('reports uncovered default-argument branches', () => expect(uncoveredBranches({ a: { type: 'default-arg', locations: [{ start: { line: 1 } }] } }, 'a', [0])).toEqual([{ start: { line: 1 }, type: 'default-arg' }]));
