...
test("formats slowest files and test cases", () => {
  const output = formatTestTimings({
    testResults: [
      {
        testFilePath: "tests\\slow.test.mjs",
        perfStats: { start: 0, end: 3000 },
        assertionResults: [
          { duration: 2500, fullName: "slow case" },
          { duration: 100, title: "small case" },
          { duration: "bad" },
        ],
      },
      {
        testFilePath: "tests/fast.test.mjs",
        perfStats: { start: 0, end: 1000 },
        assertionResults: [{ duration: 500, fullName: "fast case" }],
      },
    ],
  });
