...
import { runCoverageCheck } from "../../../../../src/checks/general/E-1/E-1.20/run-coverage-check.mjs";
const ruleId = "E-1.130.14";
const run = (context, readEvidence) => runCoverageCheck(context, ruleId, readEvidence);
