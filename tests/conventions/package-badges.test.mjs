...
test('derives public badge destinations from package metadata', () => {
  expect(checkPublicBadges('[npm](https://www.npmjs.com/package/@eliware/demo) [license](LICENSE) [ci](https://github.com/eliware/demo/actions/workflows/node.yml)', '@eliware/demo', 'https://github.com/eliware/demo')).toEqual([]);
